...
#include <sauronbot_msgs/SensorState.h>
#include <sauronbot_msgs/VersionInfo.h>
#include <string>
...
ros::Publisher sb_version_info_pub;
ros::Publisher sb_diagnostics_pub;
...
void sensorStateMsgCallback(const sauronbot_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == sauronbot_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == sauronbot_msgs::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const sauronbot_msgs::VersionInfo::ConstPtr &msg)
{
...
void msgPub()
{
  ...
  sb_diagnostics_pub.publish(tb3_diagnostics);
}
...
int main(int argc, char **argv)
{
  ...
  sb_diagnostics_pub  = nh.advertise<diagnostic_msgs::DiagnosticArray>("diagnostics", 10);
  sb_version_info_pub = nh.advertise<sauronbot_msgs::VersionInfo>("version_info", 10);
